...
void draw_flashyfonts() {
  ...
  else if (flashCounter % 100 < 51) {state = 0;}
  ...
  else if (flashCounter % 100 < 91) {state = 2;}
  else if (flashCounter % 100 < 92) {state = 1;}
  else if (flashCounter % 100 < 98) {state = 0;}
  else {state = 6;}
...
void initStateMachine() {
  ...
  stateMachine.addState(new int[]{2,60});
