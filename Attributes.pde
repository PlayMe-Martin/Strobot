...
void setAnimationAttributes() {
  ...
  animationAttributes = registerAttribute(animationAttributes, 364, "Spiraluality"                        , new String[] {"Rotating", "Smooth", "Slow", "Red"}                                                        , 16);  
  ...
  animationAttributes = registerAttribute(animationAttributes, 372, "Hypno Pendulum"                      , new String[] {"Spiral", "Blue", "Lines", "Geometric"}                                                     , 8);   
  animationAttributes = registerAttribute(animationAttributes, 373, "LargeWheel Pendulum"                 , new String[] {"Spiral", "Blue", "Lines", "Geometric"}                                                     , 8);   
