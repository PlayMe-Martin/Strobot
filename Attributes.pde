...
void setCustomDevicesActionsAttributes() {
  ...
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 16,  "All Devices - Random WhiteOut"                      , new String[] { "All Devices", "Random", "White", "Plain"                } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 17,  "LED Tubes   - Random WhiteOut"                      , new String[] { "LED Tubes",   "Random", "White", "Plain"                } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 18,  "All Devices - Random RedOut"                        , new String[] { "All Devices", "Random", "Red", "Plain"                  } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 19,  "LED Tubes   - Random RedOut"                        , new String[] { "LED Tubes",   "Random", "Red", "Plain"                  } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 20,  "All Devices - Random BlueOut"                       , new String[] { "All Devices", "Random", "Blue", "Plain"                 } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 21,  "LED Tubes   - Random BlueOut"                       , new String[] { "LED Tubes",   "Random", "Blue", "Plain"                 } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 22,  "All Devices - Random RainbowOut"                    , new String[] { "All Devices", "Random", "Rainbow", "Plain"              } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 23,  "LED Tubes   - Random RainbowOut"                    , new String[] { "LED Tubes",   "Random", "Rainbow", "Plain"              } );
  ...
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 36,  "All Devices - Random Fast White Flash"              , new String[] { "All Devices", "Random", "Fast", "White", "Flash"        } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 37,  "LED Tubes   - Random Fast White Flash"              , new String[] { "LED Tubes",   "Random", "Fast", "White", "Flash"        } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 38,  "All Devices - Random Fast Red Flash"                , new String[] { "All Devices", "Random", "Fast", "Red", "Flash"          } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 39,  "LED Tubes   - Random Fast Red Flash"                , new String[] { "LED Tubes",   "Random", "Fast", "Red", "Flash"          } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 40,  "All Devices - Random Fast Blue Flash"               , new String[] { "All Devices", "Random", "Fast", "Blue", "Flash"         } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 41,  "LED Tubes   - Random Fast Blue Flash"               , new String[] { "LED Tubes",   "Random", "Fast", "Blue", "Flash"         } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 42,  "All Devices - Random Fast Rainbow Flash"            , new String[] { "All Devices", "Random", "Fast", "Rainbow", "Flash"      } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 43,  "LED Tubes   - Random Fast Rainbow Flash"            , new String[] { "LED Tubes",   "Random", "Fast", "Rainbow", "Flash"      } );
  ...
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 56,  "All Devices - Random Slow White Flash"              , new String[] { "All Devices", "Random", "Slow", "White", "Flash"        } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 57,  "LED Tubes   - Random Slow White Flash"              , new String[] { "LED Tubes",   "Random", "Slow", "White", "Flash"        } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 58,  "All Devices - Random Slow Red Flash"                , new String[] { "All Devices", "Random", "Slow", "Red", "Flash"          } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 59,  "LED Tubes   - Random Slow Red Flash"                , new String[] { "LED Tubes",   "Random", "Slow", "Red", "Flash"          } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 60,  "All Devices - Random Slow Blue Flash"               , new String[] { "All Devices", "Random", "Slow", "Blue", "Flash"         } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 61,  "LED Tubes   - Random Slow Blue Flash"               , new String[] { "LED Tubes",   "Random", "Slow", "Blue", "Flash"         } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 62,  "All Devices - Random Slow Rainbow Flash"            , new String[] { "All Devices", "Random", "Slow", "Rainbow", "Flash"      } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 63,  "LED Tubes   - Random Slow Rainbow Flash"            , new String[] { "LED Tubes",   "Random", "Slow", "Rainbow", "Flash"      } );
  ...
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 76,  "All Devices - Random Slow White Smooth Sine"        , new String[] { "All Devices", "Random", "Slow", "White", "Smooth Sine"  } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 77,  "LED Tubes   - Random Slow White Smooth Sine"        , new String[] { "LED Tubes",   "Random", "Slow", "White", "Smooth Sine"  } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 78,  "All Devices - Random Slow Red Smooth Sine"          , new String[] { "All Devices", "Random", "Slow", "Red", "Smooth Sine"    } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 79,  "LED Tubes   - Random Slow Red Smooth Sine"          , new String[] { "LED Tubes",   "Random", "Slow", "Red", "Smooth Sine"    } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 80,  "All Devices - Random Slow Blue Smooth Sine"         , new String[] { "All Devices", "Random", "Slow", "Blue", "Smooth Sine"   } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 81,  "LED Tubes   - Random Slow Blue Smooth Sine"         , new String[] { "LED Tubes",   "Random", "Slow", "Blue", "Smooth Sine"   } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 82,  "All Devices - Random Slow Rainbow Smooth Sine"      , new String[] { "All Devices", "Random", "Slow", "Rainbow", "Smooth Sine"} );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 83,  "LED Tubes   - Random Slow Rainbow Smooth Sine"      , new String[] { "LED Tubes",   "Random", "Slow", "Rainbow", "Smooth Sine"} );
  ...
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 96,  "All Devices - Random Fast White Smooth Sine"        , new String[] { "All Devices", "Random", "Fast", "White", "Smooth Sine"  } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 97,  "LED Tubes   - Random Fast White Smooth Sine"        , new String[] { "LED Tubes",   "Random", "Fast", "White", "Smooth Sine"  } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 98,  "All Devices - Random Fast Red Smooth Sine"          , new String[] { "All Devices", "Random", "Fast", "Red", "Smooth Sine"    } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 99,  "LED Tubes   - Random Fast Red Smooth Sine"          , new String[] { "LED Tubes",   "Random", "Fast", "Red", "Smooth Sine"    } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 100, "All Devices - Random Fast Blue Smooth Sine"         , new String[] { "All Devices", "Random", "Fast", "Blue", "Smooth Sine"   } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 101, "LED Tubes   - Random Fast Blue Smooth Sine"         , new String[] { "LED Tubes",   "Random", "Fast", "Blue", "Smooth Sine"   } );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 102, "All Devices - Random Fast Rainbow Smooth Sine"      , new String[] { "All Devices", "Random", "Fast", "Rainbow", "Smooth Sine"} );
  customDevicesAttributes = registerAttribute(customDevicesAttributes, 103, "LED Tubes   - Random Fast Rainbow Smooth Sine"      , new String[] { "LED Tubes",   "Random", "Fast", "Rainbow", "Smooth Sine"} );
