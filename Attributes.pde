...
void setAnimationAttributes() {
  ...
  animationAttributes = registerAttribute(animationAttributes, 1,   "Spiraluality"                        , new String[] {"Rotating", "Smooth", "Slow", "Red"}                                                        , 16);
  animationAttributes = registerAttribute(animationAttributes, 2,   "Shadows"                             , new String[] {"Rotating", "Fast", "B&W"}                                                                  , 16);
  animationAttributes = registerAttribute(animationAttributes, 3,   "Carglass"                            , new String[] {"Geometric", "Slow", "B&W"}                                                                 , 8);
  animationAttributes = registerAttribute(animationAttributes, 4,   "Va-et-vient 1"                       , new String[] {"Geometric", "Fast", "B&W", "Rhythmic"}                                                     , 1);
  animationAttributes = registerAttribute(animationAttributes, 5,   "Va-et-vient 2"                       , new String[] {"Geometric", "Fast", "B&W", "Rhythmic"}                                                     , 1);
  animationAttributes = registerAttribute(animationAttributes, 6,   "Noise : InitFlasher"                 , new String[] {"Video", "Noise", "B&W"}                                                                    , -1);
  ...
  animationAttributes = registerAttribute(animationAttributes, 14,  "Fadeout Left"                        , new String[] {"Fade In/Out", "Very Dark"}                                                                 , 1);
  animationAttributes = registerAttribute(animationAttributes, 15,  "Fadeout Center"                      , new String[] {"Fade In/Out", "Very Dark"}                                                                 , 1);
  animationAttributes = registerAttribute(animationAttributes, 16,  "Fadeout Right"                       , new String[] {"Fade In/Out", "Very Dark"}                                                                 , 1);
  animationAttributes = registerAttribute(animationAttributes, 17,  "Fadein"                              , new String[] {"Fade In/Out", "Very Bright"}                                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 18,  "Worms"                               , new String[] {"Objects", "Circles", "Smooth", "Blue", "Slow"}                                             , 16);
  animationAttributes = registerAttribute(animationAttributes, 19,  "Upwards Line"                        , new String[] {"Geometric", "Lines", "Very Dark", "Simple", "B&W", "Rhythmic", "Set 2"}                    , 4);
  animationAttributes = registerAttribute(animationAttributes, 20,  "Wind particles"                      , new String[] {"Atmospheric", "Smooth", "Red", "Evolving"}                                                 , 16);
  animationAttributes = registerAttribute(animationAttributes, 21,  "Strobo normal"                       , new String[] {"Violent", "B&W", "Fast"}                                                                   , 1);
  animationAttributes = registerAttribute(animationAttributes, 22,  "PanelFill Line"                      , new String[] {"Geometric", "Lines", "Red"}                                                                , 1);
  animationAttributes = registerAttribute(animationAttributes, 23,  "Symmetry"                            , new String[] {"Atmospheric", "Smooth", "Complex", "Colorful"}                                             , 32);
  animationAttributes = registerAttribute(animationAttributes, 24,  "Flash Left"                          , new String[] {"Fade In/Out", "B&W", "Smooth"}                                                             , 1);
  animationAttributes = registerAttribute(animationAttributes, 25,  "Flash Center"                        , new String[] {"Fade In/Out", "B&W", "Smooth"}                                                             , 1);
  animationAttributes = registerAttribute(animationAttributes, 26,  "Flash Right"                         , new String[] {"Fade In/Out", "B&W", "Smooth"}                                                             , 1);
  animationAttributes = registerAttribute(animationAttributes, 27,  "Rhombus"                             , new String[] {"Geometric", "Colorful", "Smooth", "Slow"}                                                  , 8);
  animationAttributes = registerAttribute(animationAttributes, 28,  "Kaleido Triangle"                    , new String[] {"Geometric", "Blue", "Complex", "Evolving"}                                                 , 16);
  animationAttributes = registerAttribute(animationAttributes, 29,  "Glitch Triangle"                     , new String[] {"Geometric", "Triangles", "B&W", "Violent"}                                                 , 4);
  animationAttributes = registerAttribute(animationAttributes, 30,  "Glitch Line"                         , new String[] {"Geometric", "Lines", "B&W", "Violent"}                                                     , 4);
  animationAttributes = registerAttribute(animationAttributes, 31,  "Snow"                                , new String[] {"Atmospheric", "Noise", "B&W", "Very Dark"}                                                 , 8);
  animationAttributes = registerAttribute(animationAttributes, 32,  "Mechanic Lines"                      , new String[] {"Geometric", "Lines", "Red", "Slow"}                                                        , 4);
  animationAttributes = registerAttribute(animationAttributes, 33,  "Red vs Black vs White"               , new String[] {"Fade In/Out", "Circles", "Red", "Slow"}                                                    , 8);
  animationAttributes = registerAttribute(animationAttributes, 34,  "Rotating Square"                     , new String[] {"Geometric", "Squares", "Rotating", "Complex", "Curves", "Set 1"}                           , 16);
  animationAttributes = registerAttribute(animationAttributes, 35,  "Moving Sine"                         , new String[] {"Geometric", "B&W", "Fast", "Simple", "Set 1"}                                              , 4);
  animationAttributes = registerAttribute(animationAttributes, 36,  "Fucked Up Sine1"                     , new String[] {"Curves", "B&W", "Complex", "Fast", "Evolving", "Set 1"}                                    , 8);
  animationAttributes = registerAttribute(animationAttributes, 37,  "Fucked Up Sine2"                     , new String[] {"Curves", "B&W", "Complex", "Fast", "Evolving", "Set 1"}                                    , 8);
  animationAttributes = registerAttribute(animationAttributes, 38,  "Fucked Up Sine3"                     , new String[] {"Curves", "B&W", "Complex", "Fast", "Evolving", "Set 1"}                                    , 8);
  animationAttributes = registerAttribute(animationAttributes, 39,  "Manual Circle"                       , new String[] {"Fade In/Out", "Geometric", "Circles", "Simple", "Slow", "Blue"}                            , 4);
  animationAttributes = registerAttribute(animationAttributes, 40,  "Automatic Circle"                    , new String[] {"Geometric", "Circles", "Simple", "Slow", "Blue"}                                           , 16);
  animationAttributes = registerAttribute(animationAttributes, 41,  "Rain"                                , new String[] {"Atmospheric", "Noise", "B&W", "Very Dark"}                                                 , 16);
  animationAttributes = registerAttribute(animationAttributes, 42,  "Pulse Star"                          , new String[] {"Geometric", "Circles", "B&W", "Slow"}                                                      , 8);
  animationAttributes = registerAttribute(animationAttributes, 43,  "Arrow Shape"                         , new String[] {"Geometric", "Triangles", "Slow", "B&W"}                                                    , 8);
  animationAttributes = registerAttribute(animationAttributes, 44,  "Star - 2 sides"                      , new String[] {"Geometric", "Lines", "Slow", "Simple", "B&W", "Rhythmic", "Set 2"}                         , 2);
  animationAttributes = registerAttribute(animationAttributes, 45,  "Star - 3 sides"                      , new String[] {"Geometric", "Lines", "Slow", "Simple", "B&W", "Rhythmic", "Set 2"}                         , 2);
  animationAttributes = registerAttribute(animationAttributes, 46,  "Star - 4 sides"                      , new String[] {"Geometric", "Lines", "Slow", "Simple", "B&W", "Rhythmic", "Set 2"}                         , 2);
  animationAttributes = registerAttribute(animationAttributes, 47,  "Star - 6 sides"                      , new String[] {"Geometric", "Lines", "Slow", "Simple", "B&W", "Rhythmic", "Set 2"}                         , 2);
  animationAttributes = registerAttribute(animationAttributes, 48,  "Star - 8 sides"                      , new String[] {"Geometric", "Lines", "Slow", "Simple", "B&W", "Rhythmic", "Set 2"}                         , 2);
  animationAttributes = registerAttribute(animationAttributes, 49,  "Moving Lines"                        , new String[] {"Geometric", "Lines", "Fast", "Simple", "B&W", "Rhythmic", "Set 2"}                         , 2);
  animationAttributes = registerAttribute(animationAttributes, 50,  "Moving Squares"                      , new String[] {"Objects", "Squares", "Slow", "Simple", "B&W", "Rhythmic", "Set 2"}                         , 2);
  animationAttributes = registerAttribute(animationAttributes, 51,  "Upwards Glitch Lines"                , new String[] {"Geometric", "Lines", "Slow", "Simple", "Red", "Rhythmic", "Set 2"}                         , 2);
  animationAttributes = registerAttribute(animationAttributes, 52,  "Diagonal Glitch Lines"               , new String[] {"Geometric", "Lines", "Fast", "Simple", "Red", "Rhythmic", "Set 2"}                         , 2);
  animationAttributes = registerAttribute(animationAttributes, 53,  "Compressed Lines"                    , new String[] {"Geometric", "Lines", "Fast", "Simple", "B&W", "Rhythmic", "Set 2"}                         , 2);
  animationAttributes = registerAttribute(animationAttributes, 54,  "PanelFill Left"                      , new String[] {"Geometric", "Rhythmic", "Fast", "Simple", "B&W", "Set 3"}                                  , 1);
  animationAttributes = registerAttribute(animationAttributes, 55,  "PanelFill Center"                    , new String[] {"Geometric", "Rhythmic", "Fast", "Simple", "B&W", "Set 3"}                                  , 1);
  animationAttributes = registerAttribute(animationAttributes, 56,  "PanelFill Right"                     , new String[] {"Geometric", "Rhythmic", "Fast", "Simple", "B&W", "Set 3"}                                  , 1);
  animationAttributes = registerAttribute(animationAttributes, 57,  "Flash Left Red"                      , new String[] {"Fade In/Out", "Red", "Smooth"}                                                             , 1);
  animationAttributes = registerAttribute(animationAttributes, 58,  "Flash Center Red"                    , new String[] {"Fade In/Out", "Red", "Smooth"}                                                             , 1);
  animationAttributes = registerAttribute(animationAttributes, 59,  "Flash Right Red"                     , new String[] {"Fade In/Out", "Red", "Smooth"}                                                             , 1);
  animationAttributes = registerAttribute(animationAttributes, 60,  "Mixed Lines 1"                       , new String[] {"Geometric", "Lines", "Fast", "Simple", "B&W", "Rhythmic", "Set 4"}                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 61,  "Mixed Lines 2"                       , new String[] {"Geometric", "Lines", "Fast", "Simple", "B&W", "Rhythmic", "Set 4"}                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 62,  "Mixed Lines 3"                       , new String[] {"Geometric", "Lines", "Fast", "Simple", "B&W", "Rhythmic", "Set 4"}                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 63,  "Mixed Lines 4"                       , new String[] {"Geometric", "Lines", "Fast", "Simple", "B&W", "Rhythmic", "Set 4"}                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 64,  "Mixed Lines 5"                       , new String[] {"Geometric", "Lines", "Fast", "Simple", "B&W", "Rhythmic", "Set 4"}                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 65,  "Mixed Lines 6"                       , new String[] {"Geometric", "Lines", "Fast", "Simple", "B&W", "Rhythmic", "Set 4"}                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 66,  "Mixed Lines 7"                       , new String[] {"Geometric", "Lines", "Circles", "Fast", "Simple", "B&W", "Rhythmic", "Set 4"}              , 1);
  animationAttributes = registerAttribute(animationAttributes, 67,  "Mixed Lines 8"                       , new String[] {"Geometric", "Lines", "Circles", "Fast", "Simple", "B&W", "Rhythmic", "Set 4"}              , 1);
  animationAttributes = registerAttribute(animationAttributes, 68,  "Mixed Lines 9"                       , new String[] {"Geometric", "Circles", "Fast", "Simple", "B&W", "Rhythmic", "Set 4"}                       , 1);
  animationAttributes = registerAttribute(animationAttributes, 69,  "Mixed Lines 10"                      , new String[] {"Geometric", "Circles", "Fast", "Simple", "B&W", "Rhythmic", "Set 4"}                       , 1);
  animationAttributes = registerAttribute(animationAttributes, 70,  "Mixed Lines 11"                      , new String[] {"Geometric", "Circles", "Fast", "Simple", "B&W", "Rhythmic", "Set 4"}                       , 1);
  animationAttributes = registerAttribute(animationAttributes, 71,  "Mixed Lines 12"                      , new String[] {"Geometric", "Circles", "Fast", "Simple", "B&W", "Rhythmic", "Set 4"}                       , 1);
  animationAttributes = registerAttribute(animationAttributes, 72,  "Mixed Lines 13"                      , new String[] {"Geometric", "Circles", "Fast", "Simple", "B&W", "Rhythmic", "Set 4"}                       , 1);
  animationAttributes = registerAttribute(animationAttributes, 73,  "Mixed Lines 14"                      , new String[] {"Geometric", "Circles", "Fast", "Simple", "B&W", "Rhythmic", "Set 4"}                       , 1);
  animationAttributes = registerAttribute(animationAttributes, 74,  "StroboX"                             , new String[] {"Fade In/Out", "Violent", "Lines", "Fast", "B&W"}                                           , 1);
  animationAttributes = registerAttribute(animationAttributes, 75,  "DoubleGradient transition"           , new String[] {"Fade In/Out", "Atmospheric", "B&W", "Smooth", "Slow"}                                      , 16);
  animationAttributes = registerAttribute(animationAttributes, 76,  "CarreMarshall"                       , new String[] {"Geometric", "Squares", "B&W", "Smooth", "Slow"}                                            , 8);
  animationAttributes = registerAttribute(animationAttributes, 77,  "FuseeUp"                             , new String[] {"Fade In/Out", "B&W", "Fast"}                                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 78,  "FuseeDown"                           , new String[] {"Fade In/Out", "B&W", "Fast"}                                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 79,  "FuseeLeft"                           , new String[] {"Fade In/Out", "B&W", "Fast"}                                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 80,  "FuseeRight"                          , new String[] {"Fade In/Out", "B&W", "Fast"}                                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 81,  "FuseeCenterHorizontal"               , new String[] {"Fade In/Out", "B&W", "Fast"}                                                               , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 82,  "FuseeCenterVertical"                 , new String[] {"Fade In/Out", "B&W", "Fast"}                                                               , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 83,  "Spots"                               , new String[] {"Violent", "Geometric", "Lines", "Fast", "B&W"}                                             , 2);
  animationAttributes = registerAttribute(animationAttributes, 84,  "MarshallStrobo"                      , new String[] {"Violent", "Geometric", "Squares", "B&W", "Smooth", "Slow", "B&W"}                          , 2);
  animationAttributes = registerAttribute(animationAttributes, 85,  "StroboLine"                          , new String[] {"Violent", "Geometric", "Lines", "Fast", "B&W"}                                             , 4);
  animationAttributes = registerAttribute(animationAttributes, 86,  "UpwardsGlitchMixedLines"             , new String[] {"Geometric", "Lines", "Fast", "B&W"}                                                        , 2);
  animationAttributes = registerAttribute(animationAttributes, 87,  "UpwardsGlitchMixedLines2"            , new String[] {"Geometric", "Lines", "Fast", "B&W"}                                                        , 2);
  animationAttributes = registerAttribute(animationAttributes, 88,  "WideFlash"                           , new String[] {"Fade In/Out", "Lines", "Slow", "Smooth", "B&W"}                                            , 4);
  animationAttributes = registerAttribute(animationAttributes, 89,  "Scope"                               , new String[] {"Geometric", "Circles", "Fast", "Rotating", "Evolving", "Red"}                              , 8);
  animationAttributes = registerAttribute(animationAttributes, 90,  "SquareWaveGenerator"                 , new String[] {"Lines", "Rhythmic", "Smooth", "Red"}                                                       , 1);
  animationAttributes = registerAttribute(animationAttributes, 91,  "PixelLines"                          , new String[] {"Atmospheric", "Colorful", "Smooth"}                                                        , 16);
  animationAttributes = registerAttribute(animationAttributes, 92,  "SpiralTriangle"                      , new String[] {"Geometric", "Spiral", "B&W", "Slow"}                                                       , 16);
  animationAttributes = registerAttribute(animationAttributes, 93,  "Sonar"                               , new String[] {"Fade In/Out", "Slow", "Smooth", "B&W"}                                                     , 8);
  animationAttributes = registerAttribute(animationAttributes, 94,  "SonarAllWhite"                       , new String[] {"Fade In/Out", "Slow", "Smooth", "B&W"}                                                     , 8);
  animationAttributes = registerAttribute(animationAttributes, 95,  "Rorschach 1"                         , new String[] {"Random", "Complex", "Fast", "Smooth", "Red", "B&W"}                                        , 8);
  animationAttributes = registerAttribute(animationAttributes, 96,  "Rorschach 2"                         , new String[] {"Random", "Complex", "Fast", "Smooth", "Red", "B&W"}                                        , 8);
  animationAttributes = registerAttribute(animationAttributes, 97,  "Rorschach 3"                         , new String[] {"Random", "Complex", "Fast", "Smooth", "Red", "B&W"}                                        , 8);
  animationAttributes = registerAttribute(animationAttributes, 98,  "Rorschach 4"                         , new String[] {"Random", "Complex", "Fast", "Smooth", "Red", "B&W"}                                        , 8);
  animationAttributes = registerAttribute(animationAttributes, 99,  "Rorschach 5"                         , new String[] {"Random", "Complex", "Fast", "Smooth", "Red", "B&W"}                                        , 8);
  animationAttributes = registerAttribute(animationAttributes, 100, "RorschachSetColor"                   , new String[] {"Special", "Random", "Complex", "Fast", "Smooth", "Red", "B&W"}                             , 1);
  animationAttributes = registerAttribute(animationAttributes, 101, "RorschachSetBlack&White"             , new String[] {"Special", "Random", "Complex", "Fast", "Smooth", "Red", "B&W"}                             , 1);
  animationAttributes = registerAttribute(animationAttributes, 102, "StroboRed"                           , new String[] {"Violent", "Fast", "Red"}                                                                   , 2);
  animationAttributes = registerAttribute(animationAttributes, 103, "LowLeft"                             , new String[] {"Still", "Rhythmic", "B&W", "Set 5"}                                                        , 0.25);
  animationAttributes = registerAttribute(animationAttributes, 104, "HiLeft"                              , new String[] {"Still", "Rhythmic", "B&W", "Set 5"}                                                        , 0.25);
  animationAttributes = registerAttribute(animationAttributes, 105, "LowMid"                              , new String[] {"Still", "Rhythmic", "B&W", "Set 5"}                                                        , 0.25);
  animationAttributes = registerAttribute(animationAttributes, 106, "HiMid"                               , new String[] {"Still", "Rhythmic", "B&W", "Set 5"}                                                        , 0.25);
  animationAttributes = registerAttribute(animationAttributes, 107, "LowRight"                            , new String[] {"Still", "Rhythmic", "B&W", "Set 5"}                                                        , 0.25);
  animationAttributes = registerAttribute(animationAttributes, 108, "HiRight"                             , new String[] {"Still", "Rhythmic", "B&W", "Set 5"}                                                        , 0.25);
  animationAttributes = registerAttribute(animationAttributes, 109, "WhiteOut"                            , new String[] {"Still", "Rhythmic", "B&W", "Very Bright", "Set 5"}                                         , 0.25);
  animationAttributes = registerAttribute(animationAttributes, 110, "BlackOut"                            , new String[] {"Still", "Rhythmic", "B&W", "Very Dark", "Set 5", "Set 6"}                                  , 0.25);
  animationAttributes = registerAttribute(animationAttributes, 111, "Upwards Line White Out"              , new String[] {"Geometric", "Lines", "Slow", "B&W"}                                                        , 4);
  animationAttributes = registerAttribute(animationAttributes, 112, "Lines 1"                             , new String[] {"Still", "Rhythmic", "B&W"}                                                                 , -1);
  animationAttributes = registerAttribute(animationAttributes, 113, "Lines 2"                             , new String[] {"Still", "Rhythmic", "B&W"}                                                                 , -1);
  animationAttributes = registerAttribute(animationAttributes, 114, "Lines 3"                             , new String[] {"Still", "Rhythmic", "B&W"}                                                                 , -1);
  animationAttributes = registerAttribute(animationAttributes, 115, "Lines 4"                             , new String[] {"Still", "Rhythmic", "B&W"}                                                                 , -1);
  animationAttributes = registerAttribute(animationAttributes, 116, "Lines 5"                             , new String[] {"Still", "Rhythmic", "B&W"}                                                                 , -1);
  animationAttributes = registerAttribute(animationAttributes, 117, "Lines 6"                             , new String[] {"Still", "Rhythmic", "B&W"}                                                                 , -1);
  animationAttributes = registerAttribute(animationAttributes, 118, "Lines 7"                             , new String[] {"Still", "Rhythmic", "B&W"}                                                                 , -1);
  animationAttributes = registerAttribute(animationAttributes, 119, "Lines 8"                             , new String[] {"Still", "Rhythmic", "B&W"}                                                                 , -1);
  animationAttributes = registerAttribute(animationAttributes, 120, "Lines 9"                             , new String[] {"Still", "Rhythmic", "B&W"}                                                                 , -1);
  animationAttributes = registerAttribute(animationAttributes, 121, "Lines 10"                            , new String[] {"Still", "Rhythmic", "B&W"}                                                                 , -1);
  animationAttributes = registerAttribute(animationAttributes, 122, "Unfolding Lines"                     , new String[] {"Lines", "Slow", "B&W"}                                                                     , 4);
  animationAttributes = registerAttribute(animationAttributes, 123, "Super formula"                       , new String[] {"Complex", "Evolving", "Atmospheric", "Rhythmic", "B&W"}                                    , 1);
  animationAttributes = registerAttribute(animationAttributes, 124, "Growing Triangles"                   , new String[] {"Geometric", "Triangles", "Rhythmic", "Slow", "B&W"}                                        , 1);
  animationAttributes = registerAttribute(animationAttributes, 125, "Moire"                               , new String[] {"Atmospheric", "Complex", "Slow", "B&W"}                                                    , 32);
  animationAttributes = registerAttribute(animationAttributes, 126, "Tetris - 1 player game"              , new String[] {"Game"}                                                                                     , -1);
  animationAttributes = registerAttribute(animationAttributes, 127, "Pong - 2 player game"                , new String[] {"Game"}                                                                                     , -1);
  animationAttributes = registerAttribute(animationAttributes, 128, "Responsive Circles BW"               , new String[] {"Atmospheric", "Slow", "B&W"}                                                               , 16);
  animationAttributes = registerAttribute(animationAttributes, 129, "Responsive Circles"                  , new String[] {"Atmospheric", "Slow", "Blue"}                                                              , 16);
  animationAttributes = registerAttribute(animationAttributes, 130, "Particles Explode"                   , new String[] {"Fade In/Out", "Fast", "Rhythmic", "Blue"}                                                  , 2);
  animationAttributes = registerAttribute(animationAttributes, 131, "Progressive Red"                     , new String[] {"Fade In/Out", "Atmospheric", "Slow", "Red"}                                                , 8);
  animationAttributes = registerAttribute(animationAttributes, 132, "Color Vertex"                        , new String[] {"Atmospheric", "Fast", "Rhythmic", "Colorful", "Complex", "Evolving"}                       , 4);
  animationAttributes = registerAttribute(animationAttributes, 133, "Particles Flow"                      , new String[] {"Atmospheric", "Slow", "Blue"}                                                              , 32);
  animationAttributes = registerAttribute(animationAttributes, 134, "Bezier Flowers"                      , new String[] {"Geometric", "Lines", "Complex", "Rhythmic", "Colorful"}                                    , 4);
  animationAttributes = registerAttribute(animationAttributes, 135, "Joint Circles"                       , new String[] {"Atmospheric", "Slow", "B&W", "Simple"}                                                     , 8);
  animationAttributes = registerAttribute(animationAttributes, 136, "Tunnel White"                        , new String[] {"Atmospheric", "Fast", "B&W", "Violent", "Rhythmic", "Set 7"}                               , 4);
  animationAttributes = registerAttribute(animationAttributes, 137, "Tunnel Red "                         , new String[] {"Atmospheric", "Fast", "Red", "Violent", "Rhythmic", "Set 7"}                               , 4);
  animationAttributes = registerAttribute(animationAttributes, 138, "Cosmo Curve "                        , new String[] {"Geometric", "Spiral", "Red", "Evolving"}                                                   , 8);
  animationAttributes = registerAttribute(animationAttributes, 139, "Perlin Color "                       , new String[] {"Geometric", "Circles", "Red", "Random", "Slow"}                                            , 8);
  animationAttributes = registerAttribute(animationAttributes, 140, "Line Wide Flash "                    , new String[] {"Fade In/Out", "Simple", "Fast", "Rhythmic", "B&W"}                                         , -1);
  animationAttributes = registerAttribute(animationAttributes, 141, "Line Left Flash "                    , new String[] {"Fade In/Out", "Simple", "Fast", "Rhythmic", "B&W"}                                         , -1);
  animationAttributes = registerAttribute(animationAttributes, 142, "Line Center Flash "                  , new String[] {"Fade In/Out", "Simple", "Fast", "Rhythmic", "B&W"}                                         , -1);
  animationAttributes = registerAttribute(animationAttributes, 143, "Line Right Flash "                   , new String[] {"Fade In/Out", "Simple", "Slow", "Rhythmic", "B&W"}                                         , -1);
  animationAttributes = registerAttribute(animationAttributes, 144, "Long Wide Flash "                    , new String[] {"Fade In/Out", "Slow", "B&W"}                                                               , 8);
  animationAttributes = registerAttribute(animationAttributes, 145, "Opposite Lines No Background"        , new String[] {"Geometric", "Simple", "Lines", "Slow", "B&W"}                                              , 8);
  animationAttributes = registerAttribute(animationAttributes, 146, "Opening Lines"                       , new String[] {"Geometric", "Simple", "Lines", "B&W"}                                                      , 16);
  animationAttributes = registerAttribute(animationAttributes, 147, "Opening Lines Reinit"                , new String[] {"Geometric", "Simple", "Lines", "B&W"}                                                      , 16);
  animationAttributes = registerAttribute(animationAttributes, 148, "White Noise"                         , new String[] {"Noise", "B&W"}                                                                             , 8);
  animationAttributes = registerAttribute(animationAttributes, 149, "Single Square Spiral"                , new String[] {"Geometric", "Spiral", "Rotating", "Red", "Rhythmic", "Set 6"}                              , 4);
  animationAttributes = registerAttribute(animationAttributes, 150, "Dual Square Spiral"                  , new String[] {"Geometric", "Spiral", "Rotating", "Red", "Rhythmic", "Set 6"}                              , 4);
  animationAttributes = registerAttribute(animationAttributes, 151, "Complex Spiral Reinit"               , new String[] {"Atmospheric", "Spiral", "Rotating", "Complex", "Red"}                                      , 32);
  animationAttributes = registerAttribute(animationAttributes, 152, "Complex Spiral"                      , new String[] {"Atmospheric", "Spiral", "Rotating", "Complex", "Red"}                                      , 32);
  animationAttributes = registerAttribute(animationAttributes, 153, "Beat Circle"                         , new String[] {"Geometric", "Fast", "Circles", "Simple", "Rhythmic", "Red", "Set 8"}                       , 1);
  animationAttributes = registerAttribute(animationAttributes, 154, "Beat Circle Lines Reinit"            , new String[] {"Geometric", "Fast", "Circles", "Lines", "Simple", "Rhythmic", "Red"}                       , -1);
  animationAttributes = registerAttribute(animationAttributes, 155, "Beat Circle Lines"                   , new String[] {"Geometric", "Fast", "Circles", "Lines", "Simple", "Rhythmic", "Red", "Set 23"}             , 1);
  animationAttributes = registerAttribute(animationAttributes, 156, "Beat Circle Color Lines 1"           , new String[] {"Geometric", "Fast", "Circles", "Lines", "Simple", "Rhythmic", "Red", "Set 24"}             , 1);
  animationAttributes = registerAttribute(animationAttributes, 157, "Beat Circle Color Lines 2"           , new String[] {"Geometric", "Fast", "Circles", "Lines", "Simple", "Rhythmic", "Colorful", "Set 24"}        , 1);
  animationAttributes = registerAttribute(animationAttributes, 158, "Cosmo Curve Reinit"                  , new String[] {"Spiral", "Red", "Lines", "Complex", "Evolving"}                                            , 16);
  animationAttributes = registerAttribute(animationAttributes, 159, "Red Diagonal Lines"                  , new String[] {"Still", "Lines", "Rhythmic", "Red"}                                                        , 1);
  animationAttributes = registerAttribute(animationAttributes, 160, "Blue Diagonal Lines"                 , new String[] {"Still", "Lines", "Rhythmic", "Blue"}                                                       , 1);
  animationAttributes = registerAttribute(animationAttributes, 161, "White Noise Crescendo"               , new String[] {"Noise", "B&W"}                                                                             , 8);
  animationAttributes = registerAttribute(animationAttributes, 162, "Triangle Strobo"                     , new String[] {"Geometric", "Lines", "Violent", "Fast", "B&W"}                                             , 4);
  animationAttributes = registerAttribute(animationAttributes, 163, "Blue Diagonal Lines2"                , new String[] {"Still", "Lines", "Rhythmic", "Blue", "Set 9"}                                              , 1);
  animationAttributes = registerAttribute(animationAttributes, 164, "Blue Diagonal Lines3"                , new String[] {"Still", "Lines", "Rhythmic", "Blue", "Set 9"}                                              , 1);
  animationAttributes = registerAttribute(animationAttributes, 165, "Red Diagonal Lines2"                 , new String[] {"Still", "Lines", "Rhythmic", "Red", "Set 9"}                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 166, "White Diagonal Lines"                , new String[] {"Still", "Lines", "Rhythmic", "B&W", "Set 9"}                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 167, "White Diagonal Lines2"               , new String[] {"Still", "Lines", "Rhythmic", "B&W", "Set 9"}                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 168, "White Straight Lines"                , new String[] {"Still", "Lines", "Rhythmic", "B&W", "Set 9"}                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 169, "Inwards Spiral"                      , new String[] {"Spiral", "Blue", "Lines", "Red", "Geometric"}                                              , 2);
  animationAttributes = registerAttribute(animationAttributes, 170, "Inwards Spiral Reverse"              , new String[] {"Spiral", "Blue", "Lines", "Red", "Geometric"}                                              , 2);
  animationAttributes = registerAttribute(animationAttributes, 171, "Exploding Circle"                    , new String[] {"Geometric", "Simple", "Circles", "Fast", "Rhythmic", "B&W"}                                , 1);
  animationAttributes = registerAttribute(animationAttributes, 172, "Rotozoom White"                      , new String[] {"Atmospheric", "Complex", "Fast", "Rotating", "B&W"}                                        , 32);
  animationAttributes = registerAttribute(animationAttributes, 173, "Newton Pendulum"                     , new String[] {"Geometric", "Evolving", "Simple", "Circles", "Lines", "Fast", "B&W"}                       , 16);
  animationAttributes = registerAttribute(animationAttributes, 174, "Hypno Pendulum"                      , new String[] {"Spiral", "Blue", "Lines", "Geometric", "TO BE DELETED"}                                    , 8);
  animationAttributes = registerAttribute(animationAttributes, 175, "LargeWheel Pendulum"                 , new String[] {"Spiral", "Blue", "Lines", "Geometric", "TO BE DELETED"}                                    , 8);
  animationAttributes = registerAttribute(animationAttributes, 176, "Mugen"                               , new String[] {"Simple", "Lines", "Geometric", "B&W"}                                                      , 4);
  animationAttributes = registerAttribute(animationAttributes, 177, "Arc Wave"                            , new String[] {"Objects", "Circles", "Geometric", "B&W"}                                                   , 16);
  animationAttributes = registerAttribute(animationAttributes, 178, "Outward Spiral White"                , new String[] {"Fade In/Out", "Spiral", "Slow", "Evolving", "B&W"}                                         , 8);
  animationAttributes = registerAttribute(animationAttributes, 179, "Outward Spiral Blue"                 , new String[] {"Fade In/Out", "Spiral", "Slow", "Evolving", "Blue"}                                        , 8);
  animationAttributes = registerAttribute(animationAttributes, 180, "Outward Spiral Red"                  , new String[] {"Fade In/Out", "Spiral", "Slow", "Evolving", "Red"}                                         , 8);
  animationAttributes = registerAttribute(animationAttributes, 181, "Columns White"                       , new String[] {"Geometric", "Lines", "Slow", "Rhythmic", "B&W", "Set 10"}                                  , 2);
  animationAttributes = registerAttribute(animationAttributes, 182, "Columns Black"                       , new String[] {"Geometric", "Lines", "Slow", "Rhythmic", "B&W", "Set 10"}                                  , 2);
  animationAttributes = registerAttribute(animationAttributes, 183, "Circle Contour"                      , new String[] {"Atmospheric", "Circles", "Slow", "Very Dark", "Blue"}                                      , 8);
  animationAttributes = registerAttribute(animationAttributes, 184, "Color Explode"                       , new String[] {"Atmospheric", "Objects", "Slow", "Colorful"}                                               , 8);
  animationAttributes = registerAttribute(animationAttributes, 185, "Color Rain"                          , new String[] {"Atmospheric", "Lines", "Fast", "Colorful"}                                                 , 32);
  animationAttributes = registerAttribute(animationAttributes, 186, "Warp Speed"                          , new String[] {"Fade In/Out", "Fast", "Colorful"}                                                          , 4);
  animationAttributes = registerAttribute(animationAttributes, 187, "BW Triangles"                        , new String[] {"Geometric", "Evolving", "B&W"}                                                             , 32);
  animationAttributes = registerAttribute(animationAttributes, 188, "Glitch Diagonal Lines"               , new String[] {"Atmospheric", "Lines", "Rhythmic", "Blue"}                                                 , 8);
  animationAttributes = registerAttribute(animationAttributes, 189, "Flashing Dots Border"                , new String[] {"Atmospheric", "Circles", "Slow", "B&W"}                                                    , 16);
  animationAttributes = registerAttribute(animationAttributes, 190, "Falling Circles"                     , new String[] {"Atmospheric", "Circles", "Slow", "Blue"}                                                   , 32);
  animationAttributes = registerAttribute(animationAttributes, 191, "Set Exploding Particles"             , new String[] {"Geometric", "Circles", "Evolving", "Rhythmic", "Blue", "Set 11"}                           , 1);
  animationAttributes = registerAttribute(animationAttributes, 192, "Release Exploding Particles"         , new String[] {"Geometric", "Circles", "Evolving", "Rhythmic", "Blue", "Set 11"}                           , 1);
  animationAttributes = registerAttribute(animationAttributes, 193, "Random BW Flow"                      , new String[] {"Noise", "Complex", "B&W"}                                                                  , 16);
  animationAttributes = registerAttribute(animationAttributes, 194, "Tesselate"                           , new String[] {"Geometric", "Squares", "Red", "Blue"}                                                      , 32);
  animationAttributes = registerAttribute(animationAttributes, 195, "Digital Hex Particles"               , new String[] {"Fade In/Out", "Colorful", "Very Dark", "Lines", "Slow"}                                    , 1);
  animationAttributes = registerAttribute(animationAttributes, 196, "Red Arc Transition"                  , new String[] {"Fade In/Out", "Red", "Circles", "Fast"}                                                    , 2);
  animationAttributes = registerAttribute(animationAttributes, 197, "Blue Arc Transition"                 , new String[] {"Fade In/Out", "Blue", "Circles", "Fast"}                                                   , 2);
  animationAttributes = registerAttribute(animationAttributes, 198, "Light Blobs"                         , new String[] {"Objects", "Circles", "Atmospheric", "Red"}                                                 , 32);
  animationAttributes = registerAttribute(animationAttributes, 199, "Random Smoke Particles"              , new String[] {"Noise", "Evolving", "Atmospheric", "B&W"}                                                  , 16);
  animationAttributes = registerAttribute(animationAttributes, 200, "Red Meta Balls"                      , new String[] {"Objects", "Circles", "Atmospheric", "Red"}                                                 , 32);
  animationAttributes = registerAttribute(animationAttributes, 201, "Butterfly"                           , new String[] {"Atmospheric", "Evolving", "Slow", "Very Dark", "Blue"}                                     , 16);
  animationAttributes = registerAttribute(animationAttributes, 202, "Circle Pusher Rotate"                , new String[] {"Geometric", "Evolving", "Circles", "Rotating", "B&W", "Rhythmic", "Set 12"}                , 4);
  animationAttributes = registerAttribute(animationAttributes, 203, "Circle Pusher Straight"              , new String[] {"Geometric", "Evolving", "Circles", "B&W", "Rhythmic",  "Set 12"}                           , 4);
  animationAttributes = registerAttribute(animationAttributes, 204, "Shutter"                             , new String[] {"Geometric", "Atmospheric", "Red", "Slow"}                                                  , 16);
  animationAttributes = registerAttribute(animationAttributes, 205, "Orbiting Particles"                  , new String[] {"Objects", "Circles", "Fast", "B&W", "Rhythmic"}                                            , 2);
  animationAttributes = registerAttribute(animationAttributes, 206, "Vines"                               , new String[] {"Objects", "Lines", "Fast", "Red", "Evolving"}                                              , 32);
  animationAttributes = registerAttribute(animationAttributes, 207, "Arrow Style"                         , new String[] {"Geometric", "Lines", "Fast", "B&W"}                                                        , 16);
  animationAttributes = registerAttribute(animationAttributes, 208, "Single Arrow - Up-Down White"        , new String[] {"Geometric", "Objects", "Rhythmic", "Lines", "Fast", "B&W", "Set 13"}                       , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 209, "Single Arrow - Left-Right White"     , new String[] {"Geometric", "Objects", "Rhythmic", "Lines", "Fast", "B&W", "Set 13"}                       , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 210, "Single Arrow - Right-Left White"     , new String[] {"Geometric", "Objects", "Rhythmic", "Lines", "Fast", "B&W", "Set 13"}                       , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 211, "Single Arrow - Down-Up White"        , new String[] {"Geometric", "Objects", "Rhythmic", "Lines", "Fast", "B&W", "Set 13"}                       , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 212, "Single Arrow - Up-Down Red"          , new String[] {"Geometric", "Objects", "Rhythmic", "Lines", "Fast", "Red", "Set 13"}                       , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 213, "Single Arrow - Left-Right Red"       , new String[] {"Geometric", "Objects", "Rhythmic", "Lines", "Fast", "Red", "Set 13"}                       , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 214, "Single Arrow - Right-Left Red"       , new String[] {"Geometric", "Objects", "Rhythmic", "Lines", "Fast", "Red", "Set 13"}                       , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 215, "Single Arrow - Down-Up Red"          , new String[] {"Geometric", "Objects", "Rhythmic", "Lines", "Fast", "Red", "Set 13"}                       , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 216, "Rotozoom 1"                          , new String[] {"Atmospheric", "Rotating", "Complex", "Red"}                                                , 32);
  animationAttributes = registerAttribute(animationAttributes, 217, "Rotozoom 2"                          , new String[] {"Atmospheric", "Rotating", "Complex", "Red"}                                                , 32);
  animationAttributes = registerAttribute(animationAttributes, 218, "Rotozoom 3"                          , new String[] {"Atmospheric", "Rotating", "Complex", "Red"}                                                , 32);
  animationAttributes = registerAttribute(animationAttributes, 219, "Milktank"                            , new String[] {"Atmospheric", "Objects", "Fast", "B&W", "Evolving"}                                        , 16);
  animationAttributes = registerAttribute(animationAttributes, 220, "Fire Noise Squares"                  , new String[] {"Atmospheric", "Noise", "Red", "Evolving", "Smooth"}                                        , 16);
  animationAttributes = registerAttribute(animationAttributes, 221, "Slasher"                             , new String[] {"Geometric", "Lines", "Objects", "Fast", "Colorful", "Rhythmic"}                            , 32);
  animationAttributes = registerAttribute(animationAttributes, 222, "Neko Jiru"                           , new String[] {"Special", "Video", "Simple", "Colorful"}                                                   , 32);
  animationAttributes = registerAttribute(animationAttributes, 223, "Letter Explode"                      , new String[] {"Special", "Objects", "Fast", "B&W", "Red"}                                                 , 16);
  animationAttributes = registerAttribute(animationAttributes, 224, "Triangle Strobo"                     , new String[] {"Geometric", "Triangles", "Fast", "Red", "Blue", "Violent"}                                 , 2);
  animationAttributes = registerAttribute(animationAttributes, 225, "Exploding Circle Left"               , new String[] {"Geometric", "Circles", "Fast", "B&W", "Rhythmic", "Set 25"}                                , 1);
  animationAttributes = registerAttribute(animationAttributes, 226, "Exploding Circle Right"              , new String[] {"Geometric", "Circles", "Fast", "Red", "Rhythmic", "Set 25"}                                , 1);
  animationAttributes = registerAttribute(animationAttributes, 227, "Thunder Lines Init"                  , new String[] {"Atmospheric", "Lines", "Fast", "B&W", "Smooth"}                                            , 16);
  animationAttributes = registerAttribute(animationAttributes, 228, "Thunder Lines - More Lines"          , new String[] {"Atmospheric", "Lines", "Fast", "B&W", "Smooth"}                                            , 16);
  animationAttributes = registerAttribute(animationAttributes, 229, "Thunder Lines - Less Lines"          , new String[] {"Atmospheric", "Lines", "Fast", "B&W", "Smooth"}                                            , 16);
  animationAttributes = registerAttribute(animationAttributes, 230, "Double Fusee"                        , new String[] {"Fade In/Out", "Fast", "B&W"}                                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 231, "Disco Star"                          , new String[] {"Atmospheric", "Rotating", "Slow", "Colorful"}                                              , 32);
  animationAttributes = registerAttribute(animationAttributes, 232, "Worm Hole"                           , new String[] {"Atmospheric", "Rotating", "Circles", "Lines", "Slow", "Blue", "Evolving", "Rhythmic"}      , 2);
  animationAttributes = registerAttribute(animationAttributes, 233, "Atoms - One Electron"                , new String[] {"Geometric", "Circles", "Fast", "Rhythmic", "Red", "Set 14"}                                , 1);
  animationAttributes = registerAttribute(animationAttributes, 234, "Atoms - Two Electrons"               , new String[] {"Geometric", "Circles", "Fast", "Rhythmic", "Red", "Set 14"}                                , 1);
  animationAttributes = registerAttribute(animationAttributes, 235, "Atoms - Three Electrons"             , new String[] {"Geometric", "Circles", "Fast", "Rhythmic", "Red", "Set 14"}                                , 1);
  animationAttributes = registerAttribute(animationAttributes, 236, "Perfect Circle"                      , new String[] {"Geometric", "Circles", "Fast", "Rhythmic", "Red", "Set 14"}                                , 1);
  animationAttributes = registerAttribute(animationAttributes, 237, "Hyper Speed"                         , new String[] {"Atmospheric", "Lines", "Fast", "B&W"}                                                      , 32);
  animationAttributes = registerAttribute(animationAttributes, 238, "Color Waves - Regular"               , new String[] {"Atmospheric", "Circles", "Fast", "Red", "Rhythmic"}                                        , -1);
  animationAttributes = registerAttribute(animationAttributes, 239, "Color Waves - Strong"                , new String[] {"Atmospheric", "Circles", "Fast", "Red", "Rhythmic"}                                        , -1);
  animationAttributes = registerAttribute(animationAttributes, 240, "Continuous Triangles Resync "        , new String[] {"Geometric", "Triangles", "Slow", "Rhythmic", "B&W", "Set 16"}                              , 2);
  animationAttributes = registerAttribute(animationAttributes, 241, "Continuous Triangles Resync Invert"  , new String[] {"Geometric", "Triangles", "Slow", "Rhythmic", "B&W", "Set 16"}                              , 2);
  animationAttributes = registerAttribute(animationAttributes, 242, "Continuous Triangles Drift"          , new String[] {"Geometric", "Triangles", "Slow", "Rhythmic", "B&W", "Set 16"}                              , 2);
  animationAttributes = registerAttribute(animationAttributes, 243, "Continuous Triangles Drift Invert"   , new String[] {"Geometric", "Triangles", "Slow", "Rhythmic", "B&W", "Set 16"}                              , 2);
  animationAttributes = registerAttribute(animationAttributes, 244, "Mandala"                             , new String[] {"Geometric", "Circles", "Fast", "Rhythmic", "Red", "Complex", "Set 17"}                     , 1);
  animationAttributes = registerAttribute(animationAttributes, 245, "Mandala - change shape"              , new String[] {"Geometric", "Circles", "Fast", "Rhythmic", "Red", "Complex", "Set 17"}                     , 1);
  animationAttributes = registerAttribute(animationAttributes, 246, "Kaleido"                             , new String[] {"Geometric", "Circles", "Evolving", "Random", "Red", "Blue", "Complex"}                     , 32);
  animationAttributes = registerAttribute(animationAttributes, 247, "Kaleido Inverse"                     , new String[] {"Geometric", "Circles", "Evolving", "Random", "Red", "Blue", "Complex"}                     , 32);
  animationAttributes = registerAttribute(animationAttributes, 248, "Flower"                              , new String[] {"Atmospheric", "Circles", "Evolving", "Colorful", "Rhythmic"}                               , 2);
  animationAttributes = registerAttribute(animationAttributes, 249, "Electric Spiral"                     , new String[] {"Geometric", "Spiral", "Evolving", "Red"}                                                   , 16);
  animationAttributes = registerAttribute(animationAttributes, 250, "Small Square Left"                   , new String[] {"Geometric", "Squares", "Violent", "Fast", "B&W", "Rhythmic", "Set 18"}                     , 1);
  animationAttributes = registerAttribute(animationAttributes, 251, "Small Square Center"                 , new String[] {"Geometric", "Squares", "Violent", "Fast", "B&W", "Rhythmic", "Set 18"}                     , 1);
  animationAttributes = registerAttribute(animationAttributes, 252, "Small Square Right"                  , new String[] {"Geometric", "Squares", "Violent", "Fast", "B&W", "Rhythmic", "Set 18"}                     , 1);
  animationAttributes = registerAttribute(animationAttributes, 253, "Small Squares"                       , new String[] {"Geometric", "Squares", "Violent", "Fast", "B&W", "Rhythmic", "Set 18"}                     , 1);
  animationAttributes = registerAttribute(animationAttributes, 254, "Fast Spiral"                         , new String[] {"Spiral", "Circles", "Slow", "Red"}                                                         , 8);
  animationAttributes = registerAttribute(animationAttributes, 255, "Weird Square"                        , new String[] {"Atmospheric", "Slow", "Red"}                                                               , 32);
  animationAttributes = registerAttribute(animationAttributes, 256, "Columns White Red"                   , new String[] {"Geometric", "Slow", "Red", "Rhythmic", "Set 10"}                                           , 2);
  animationAttributes = registerAttribute(animationAttributes, 257, "Columns Black Red"                   , new String[] {"Geometric", "Slow", "Red", "Rhythmic", "Set 10"}                                           , 2);
  animationAttributes = registerAttribute(animationAttributes, 258, "Spots Multi Color"                   , new String[] {"Geometric", "Lines", "Blue", "Colorful", "Violent"}                                        , 4);
  animationAttributes = registerAttribute(animationAttributes, 259, "Strobo Line Color"                   , new String[] {"Geometric", "Lines", "Blue", "Colorful", "Violent"}                                        , 4);
  animationAttributes = registerAttribute(animationAttributes, 260, "Strobo Color"                        , new String[] {"Geometric", "Simple", "Blue", "Violent"}                                                   , 2);
  animationAttributes = registerAttribute(animationAttributes, 261, "Fusee Up"                            , new String[] {"Fade In/Out", "Fast", "Red"}                                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 262, "Fusee Down"                          , new String[] {"Fade In/Out", "Fast", "Red"}                                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 263, "Fusee Left"                          , new String[] {"Fade In/Out", "Fast", "Red"}                                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 264, "Fusee Right"                         , new String[] {"Fade In/Out", "Fast", "Red"}                                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 265, "Fusee Center Horizontal"             , new String[] {"Fade In/Out", "Fast", "Red"}                                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 266, "Fusee Center Vertical"               , new String[] {"Fade In/Out", "Fast", "Red"}                                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 267, "Wide Flash Red"                      , new String[] {"Fade In/Out", "Slow", "Red"}                                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 268, "Double Flowers"                      , new String[] {"Atmospheric", "Slow", "Red"}                                                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 269, "3D Big Ass Cube"                     , new String[] {"3D", "Slow", "Red", "Rhythmic", "Set 19"}                                                  , 4);
  animationAttributes = registerAttribute(animationAttributes, 270, "3D Corner Cube"                      , new String[] {"3D", "Slow", "Red", "Rhythmic", "Set 19"}                                                  , 4);
  animationAttributes = registerAttribute(animationAttributes, 271, "3D Glitch Cube"                      , new String[] {"3D", "Slow", "Red", "Rhythmic", "Violent", "Set 19"}                                       , 4);
  animationAttributes = registerAttribute(animationAttributes, 272, "3D No Glitch Cube"                   , new String[] {"3D", "Slow", "Red", "Rhythmic", "Set 19"}                                                  , 4);
  animationAttributes = registerAttribute(animationAttributes, 273, "3D Jerky Cube"                       , new String[] {"3D", "Slow", "B&W", "Rhythmic", "Violent", "Set 19"}                                       , 4);
  animationAttributes = registerAttribute(animationAttributes, 274, "3D Moving Jerky Cube"                , new String[] {"3D", "Slow", "B&W", "Rhythmic", "Violent", "Set 19"}                                       , 4);
  animationAttributes = registerAttribute(animationAttributes, 275, "3D Double Cube"                      , new String[] {"3D", "Slow", "Red", "Rhythmic", "Violent", "Set 19"}                                       , 4);
  animationAttributes = registerAttribute(animationAttributes, 276, "3D Single Pyramid"                   , new String[] {"3D", "Slow", "B&W", "Rhythmic", "Set 19"}                                                  , 4);
  animationAttributes = registerAttribute(animationAttributes, 277, "3D Multiple Pyramids"                , new String[] {"3D", "Slow", "Red", "Rhythmic", "Set 19"}                                                  , 8);
  animationAttributes = registerAttribute(animationAttributes, 278, "Blood Ski"                           , new String[] {"Atmospheric", "Fast", "Red"}                                                               , 32);
  animationAttributes = registerAttribute(animationAttributes, 279, "Gloubiboulga"                        , new String[] {"Geometric", "Atmospheric", "Complex", "Colorful", "Fast"}                                  , 16);
  animationAttributes = registerAttribute(animationAttributes, 280, "Revolution Lines"                    , new String[] {"Geometric", "Atmospheric", "Circles", "Colorful", "Fast"}                                  , 16);
  animationAttributes = registerAttribute(animationAttributes, 281, "Red Noise Shape 1"                   , new String[] {"Noise", "Red", "Fast", "Set 20"}                                                           , 2);
  animationAttributes = registerAttribute(animationAttributes, 282, "Red Noise Shape 2"                   , new String[] {"Geometric", "Lines", "Noise", "Red", "Fast", "Set 20"}                                     , 2);
  animationAttributes = registerAttribute(animationAttributes, 283, "Red Noise Shape 3"                   , new String[] {"Geometric", "Lines", "Noise", "Red", "Fast", "Violent", "Set 20"}                          , 2);
  animationAttributes = registerAttribute(animationAttributes, 284, "Red Noise Shape 4"                   , new String[] {"Geometric", "Triangles", "Noise", "Red", "Fast", "Violent", "Set 20"}                      , 2);
  animationAttributes = registerAttribute(animationAttributes, 285, "Red Noise Shape 5"                   , new String[] {"Geometric", "Circles", "Noise", "Red", "Fast", "Set 20"}                                   , 2);
  animationAttributes = registerAttribute(animationAttributes, 286, "Red Noise Shape 6"                   , new String[] {"Geometric", "Lines", "Noise", "Red", "Fast", "Violent"}                                    , 2);
  animationAttributes = registerAttribute(animationAttributes, 287, "Turning Single Lines"                , new String[] {"Geometric", "Lines", "Simple", "B&W", "Slow", "Rotating"}                                  , 16);
  animationAttributes = registerAttribute(animationAttributes, 288, "Random Appearing Lines"              , new String[] {"Geometric", "Lines", "B&W", "Slow", "Rotating"}                                            , 16);
  animationAttributes = registerAttribute(animationAttributes, 289, "Impulse White Rectangle - Horizontal", new String[] {"Geometric", "Squares", "B&W", "Fast", "Rhythmic", "Set 21"}                                , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 290, "Impulse White Rectangle - Vertical"  , new String[] {"Geometric", "Squares", "B&W", "Fast", "Rhythmic", "Set 21"}                                , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 291, "Impulse Red Rectangle - Horizontal"  , new String[] {"Geometric", "Squares", "Red", "Fast", "Rhythmic", "Set 21"}                                , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 292, "Impulse Red Rectangle - Vertical"    , new String[] {"Geometric", "Squares", "Red", "Fast", "Rhythmic", "Set 21"}                                , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 293, "Crescent"                            , new String[] {"Atmospheric", "Lines", "Red", "Slow", "Colorful"}                                          , 32);
  animationAttributes = registerAttribute(animationAttributes, 294, "Clock"                               , new String[] {"Geometric", "Lines", "Red", "Rhythmic"}                                                    , 2);
  animationAttributes = registerAttribute(animationAttributes, 295, "Color Beat"                          , new String[] {"Geometric", "Lines", "Colorful", "Fast", "Rhythmic"}                                       , 1);
  animationAttributes = registerAttribute(animationAttributes, 296, "Color Beat Stroboline"               , new String[] {"Geometric", "Lines", "Colorful", "Fast", "Violent", "Set 22"}                              , 1);
  animationAttributes = registerAttribute(animationAttributes, 297, "Color Beat White Strobo Triangle"    , new String[] {"Geometric", "Triangles", "B&W", "Fast", "Violent", "Set 22"}                               , 1);
  animationAttributes = registerAttribute(animationAttributes, 298, "Color Beat Transition"               , new String[] {"Fade In/Out", "Lines", "Colorful", "Fast", "Set 22"}                                       , 1);
  animationAttributes = registerAttribute(animationAttributes, 299, "Invert Explode"                      , new String[] {"Geometric", "Circles", "Rotating", "Lines", "Colorful", "Fast", "Rhythmic"}                , 2);
  animationAttributes = registerAttribute(animationAttributes, 300, "Particles Flow Red"                  , new String[] {"Atmospheric", "Slow", "Red", "Smooth"}                                                     , 32);
  animationAttributes = registerAttribute(animationAttributes, 301, "Dark Snakes"                         , new String[] {"Fade In/Out", "Slow", "Smooth"}                                                            , 4);
  animationAttributes = registerAttribute(animationAttributes, 302, "Bright Snakes"                       , new String[] {"Fade In/Out", "Slow", "Smooth"}                                                            , 4);
  animationAttributes = registerAttribute(animationAttributes, 303, "Light Painting"                      , new String[] {"3D", "Fast", "Objects", "Colorful", "Rhythmic"}                                            , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 304, "Shift Pixels Up / Slow"              , new String[] {"Special", "Slow", "Rhythmic"}                                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 305, "Shift Pixels Down / Slow"            , new String[] {"Special", "Slow", "Rhythmic"}                                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 306, "Shift Pixels Left / Slow"            , new String[] {"Special", "Slow", "Rhythmic"}                                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 307, "Shift Pixels Right / Slow"           , new String[] {"Special", "Slow", "Rhythmic"}                                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 308, "Shift Pixels Up / Fast"              , new String[] {"Special", "Fast", "Rhythmic"}                                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 309, "Shift Pixels Down / Fast"            , new String[] {"Special", "Fast", "Rhythmic"}                                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 310, "Shift Pixels Left / Fast"            , new String[] {"Special", "Fast", "Rhythmic"}                                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 311, "Shift Pixels Right / Fast"           , new String[] {"Special", "Fast", "Rhythmic"}                                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 312, "Shred Pixels Vertical / Slow"        , new String[] {"Special", "Slow", "Rhythmic", "Violent"}                                                   , -1);
  animationAttributes = registerAttribute(animationAttributes, 313, "Shred Pixels Horizontal / Slow"      , new String[] {"Special", "Slow", "Rhythmic", "Violent"}                                                   , -1);
  animationAttributes = registerAttribute(animationAttributes, 314, "Shred Pixels Vertical / Slow"        , new String[] {"Special", "Fast", "Rhythmic", "Violent"}                                                   , -1);
  animationAttributes = registerAttribute(animationAttributes, 315, "Shred Pixels Horizontal / Slow"      , new String[] {"Special", "Fast", "Rhythmic", "Violent"}                                                   , -1);
  animationAttributes = registerAttribute(animationAttributes, 316, "Light Fusion"                        , new String[] {"Atmospheric", "Fast", "B&W", "Violent"}                                                    , 32);
  animationAttributes = registerAttribute(animationAttributes, 317, "Random Paint"                        , new String[] {"Atmospheric", "Smooth", "Random", "Red"}                                                   , 16);
  animationAttributes = registerAttribute(animationAttributes, 318, "Red Wave"                            , new String[] {"Atmospheric", "Smooth", "Slow", "Red"}                                                     , 16);
  animationAttributes = registerAttribute(animationAttributes, 319, "Diagonal Color"                      , new String[] {"Atmospheric", "Geometric", "Smooth", "Slow", "Colorful"}                                   , 32);
  animationAttributes = registerAttribute(animationAttributes, 320, "Hypno Spiral Red"                    , new String[] {"Spiral", "Fast", "Red"}                                                                    , 32);
  animationAttributes = registerAttribute(animationAttributes, 321, "Night Road"                          , new String[] {"Geometric", "Lines", "Rhythmic", "Blue"}                                                   , 1);
  animationAttributes = registerAttribute(animationAttributes, 322, "Hypno Flash Triangle"                , new String[] {"Geometric", "Triangles", "Rhythmic", "Red", "Violent"}                                     , 1);
  animationAttributes = registerAttribute(animationAttributes, 323, "Rotating Cut Black"                  , new String[] {"Atmospheric", "Fast", "B&W", "Rotating"}                                                   , 16);
  animationAttributes = registerAttribute(animationAttributes, 324, "Rotating Cut Blue"                   , new String[] {"Atmospheric", "Fast", "Blue", "Rotating"}                                                  , 16);
  animationAttributes = registerAttribute(animationAttributes, 325, "Arc Rot Green"                       , new String[] {"Atmospheric", "Rhythmic", "Geometric", "Circles", "Slow", "Colorful", "Rotating", "Set 15"}, 1);
  animationAttributes = registerAttribute(animationAttributes, 326, "Arc Rot Red"                         , new String[] {"Atmospheric", "Rhythmic", "Geometric", "Circles", "Slow", "Red", "Rotating", "Set 15"}     , 1);
  ...
  animationAttributes = registerAttribute(animationAttributes, 334, "Nonotak 4"                           , new String[] {"Geometric", "B&W", "Simple", "Rhythmic", "Set 26"}                                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 335, "Nonotak 5"                           , new String[] {"Geometric", "B&W", "Simple", "Rhythmic", "Set 26"}                                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 336, "Nonotak PanelFill Left"              , new String[] {"Geometric", "B&W", "Simple", "Rhythmic", "Set 27"}                                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 337, "Nonotak PanelFill Center"            , new String[] {"Geometric", "B&W", "Simple", "Rhythmic", "Set 27"}                                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 338, "Nonotak PanelFill Right"             , new String[] {"Geometric", "B&W", "Simple", "Rhythmic", "Set 27"}                                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 339, "Random White Line Flash"             , new String[] {"Geometric", "B&W", "Simple", "Rhythmic"}                                                   , 0.25);
  animationAttributes = registerAttribute(animationAttributes, 340, "Nonotak Woosh 1"                     , new String[] {"Geometric", "B&W", "Simple", "Rhythmic", "Set 28"}                                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 341, "Nonotak Woosh 2"                     , new String[] {"Geometric", "B&W", "Simple", "Rhythmic", "Set 28"}                                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 342, "Nonotak Woosh 3"                     , new String[] {"Geometric", "B&W", "Simple", "Rhythmic", "Set 28"}                                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 343, "Nonotak Woosh 4"                     , new String[] {"Geometric", "B&W", "Simple", "Rhythmic", "Set 28"}                                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 344, "Rotating Cut - Fast"                 , new String[] {"Atmospheric", "Fast", "B&W", "Rotating"}                                                   , 16);
  animationAttributes = registerAttribute(animationAttributes, 345, "Patatap 1"                           , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 346, "Patatap 2"                           , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 347, "Patatap 3"                           , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 348, "Patatap 4"                           , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 349, "Patatap 5"                           , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 350, "Patatap 6"                           , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 351, "Patatap 7"                           , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 352, "Patatap 8"                           , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 353, "Patatap 9"                           , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 354, "Patatap 10"                          , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 355, "Patatap 11"                          , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 356, "Patatap 12"                          , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 357, "Patatap 13"                          , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 358, "Patatap 14"                          , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 359, "Patatap 15"                          , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 360, "Patatap 16"                          , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic"}                                              , -1);
  animationAttributes = registerAttribute(animationAttributes, 361, "Parallel Worlds - Regular"           , new String[] {"Geometric", "B&W", "Simple", "Rhythmic"}                                                   , 1);
  animationAttributes = registerAttribute(animationAttributes, 362, "Parallel Worlds - Slow"              , new String[] {"Geometric", "B&W", "Simple", "Rhythmic"}                                                   , 2);
  animationAttributes = registerAttribute(animationAttributes, 363, "Parallel Worlds - Red Flash"         , new String[] {"Geometric", "Red", "Simple", "Rhythmic"}                                                   , 1);
  animationAttributes = registerAttribute(animationAttributes, 364, "Parallel Worlds - Reverse"           , new String[] {"Geometric", "Red", "Simple", "Rhythmic"}                                                   , 1);
  animationAttributes = registerAttribute(animationAttributes, 365, "Fireflies"                           , new String[] {"Atmospheric", "Red", "Complex", "Slow"}                                                    , 16);
  animationAttributes = registerAttribute(animationAttributes, 366, "MultiCrecy - Low Intensity"          , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic", "Violent", "Set 29"}                         , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 367, "MultiCrecy - Medium Intensity"       , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic", "Violent", "Set 29"}                         , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 368, "MultiCrecy - High Intensity"         , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic", "Violent", "Set 29"}                         , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 369, "MultiCrecy - Hardcore Intensity"     , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic", "Violent", "Set 29"}                         , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 370, "Snake - Single"                      , new String[] {"Geometric", "Red", "Simple", "Set 30"}                                                     , 4);
  animationAttributes = registerAttribute(animationAttributes, 371, "Snake - Double"                      , new String[] {"Geometric", "Red", "Simple", "Set 30"}                                                     , 4);
  animationAttributes = registerAttribute(animationAttributes, 372, "Snake - Triple"                      , new String[] {"Geometric", "Red", "Simple", "Set 30"}                                                     , 4);
  animationAttributes = registerAttribute(animationAttributes, 373, "Snake - Four"                        , new String[] {"Geometric", "Red", "Simple", "Set 30"}                                                     , 4);
  animationAttributes = registerAttribute(animationAttributes, 374, "Snake - Five"                        , new String[] {"Geometric", "Red", "Simple", "Set 30"}                                                     , 4);
  animationAttributes = registerAttribute(animationAttributes, 375, "Snake - Six"                         , new String[] {"Geometric", "Red", "Simple", "Set 30"}                                                     , 4);
  animationAttributes = registerAttribute(animationAttributes, 376, "Periodic Noise"                      , new String[] {"Atmospheric", "B&W", "Noise"}                                                              , 16);
  animationAttributes = registerAttribute(animationAttributes, 377, "Sweeping Balls And Arrows"           , new String[] {"Geometric", "B&W", "Complex", "Rhythmic"}                                                  , 1);
  animationAttributes = registerAttribute(animationAttributes, 378, "Rotating Half Circle"                , new String[] {"Atmospheric", "Red", "Complex", "Slow", "Smooth", "Rotating"}                              , 32);
  animationAttributes = registerAttribute(animationAttributes, 379, "Fucked Up Sine 2 - No Reinit"        , new String[] {"Curves", "B&W", "Complex", "Fast", "Evolving"}                                             , 16);
  animationAttributes = registerAttribute(animationAttributes, 380, "MultiCrecy - Very Low Intensity"     , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic", "Very Dark", "Set 29"}                       , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 381, "MultiCrecy - Double Intensity"       , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic", "Violent", "Set 29"}                         , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 382, "MultiCrecy - Refrain"                , new String[] {"Geometric", "Colorful", "Simple", "Rhythmic", "Violent", "Set 29"}                         , 0.5);
  animationAttributes = registerAttribute(animationAttributes, 383, "Nonotak PanelFill Extreme Left"      , new String[] {"Geometric", "B&W", "Simple", "Rhythmic", "Set 27"}                                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 384, "Nonotak PanelFill Extreme Right"     , new String[] {"Geometric", "B&W", "Simple", "Rhythmic", "Set 27"}                                         , 1);
  animationAttributes = registerAttribute(animationAttributes, 385, "Tumbler"                             , new String[] {"Geometric", "B&W", "Simple", "Lines", "Rotating"}                                          , 16);
  animationAttributes = registerAttribute(animationAttributes, 386, "Dynamic Angle Lines - White"         , new String[] {"Geometric", "B&W", "Simple", "Lines", "Rotating", "Rhythmic"}                              , 1);
  animationAttributes = registerAttribute(animationAttributes, 387, "Dynamic Angle Lines - Half Red"      , new String[] {"Geometric", "Red", "Simple", "Lines", "Rotating", "Rhythmic"}                              , 1);
  animationAttributes = registerAttribute(animationAttributes, 388, "Dynamic Angle Lines - Red"           , new String[] {"Geometric", "Red", "Simple", "Lines", "Rotating", "Rhythmic"}                              , 1);
  animationAttributes = registerAttribute(animationAttributes, 389, "Fauve Random Flash"                  , new String[] {"Atmospheric", "Red", "Simple"}                                                             , 8);
  animationAttributes = registerAttribute(animationAttributes, 390, "Bar Waves - White"                   , new String[] {"Geometric", "B&W", "Lines"}                                                                , 8);
  animationAttributes = registerAttribute(animationAttributes, 391, "Bar Waves - Red"                     , new String[] {"Geometric", "Red", "Lines"}                                                                , 8);
  animationAttributes = registerAttribute(animationAttributes, 392, "Bar Waves - Blue"                    , new String[] {"Geometric", "Blue", "Lines"}                                                               , 8);
