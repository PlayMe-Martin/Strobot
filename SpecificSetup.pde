...
void specificActions() {
  ...
  if (drawAnimation == 1)
  {
    ...
    switch(animationnumber) {
      ...
      case 7:    //RedWhiteGlowingBalls
      
        frameRate(50);
        break;
        
      case 8:    //RedWhiteGlowingBalls - 2

        frameRate(50);
        break;
      
      case 9:    //FlashExtremeLeft
      ...
      case 81:    //Fusee center Horizontal

        fusee_init(4);
        break;
      
      case 82:    //Fusee center Vertical
      ...
      case 86:    //UpwardsGlitchMixedLines
      ...
      case 87:    //UpwardsGlitchMixedLines2
      ...
      case 101:    //RorschachSetBlack&White
      ...
      case 111:    //Upwards Line White Out
      ...
      case 131:    //ProgressiveRed

        frameRate(50);
        progressivered_color = 0;
        break;
      
      case 132:    //ColorVertex
      ...
      case 145:    //OppositeLinesNoBackground
      ...
      case 156:    //BeatCircleColorLines1
      ...
      case 157:    //BeatCircleColorLines2
      ...
      case 172:    //RotozoomWhite

        frameRate(50);
        colorMode(RGB);
        break;
      
      case 173:    //NewtonPendulum
      ...
      case 178:    //OutwardSpiralWhite

        outwardspiral_init();
        break;
      
      case 179:    //OutwardSpiralBlue

        outwardspiral_init();
        break;
      
      case 180:    //OutwardSpiralRed

        outwardspiral_init();
        break;
      
      case 181:    //ColumnsWhite
      ...
      case 191:    //SetExplodingParticles
      ...
      case 192:    //ReleaseExplodingParticles
      ...
      case 228:    //ThunderLines - More lines
      ...
      case 229:    //ThunderLines - Less lines
      ...
      case 233:    //Atoms - One Electron
  
        atoms_setup(1);
        break;
      
      case 234:    //Atoms - Two Electron
 
        atoms_setup(2);
        break;
      
      case 235:    //Atoms - Three Electron
       
        atoms_setup(3);
        break;
      
      case 236:    //PerfectCircle
      ...
      case 240:    //ContinuousTriangles - Resynchronize
      ...
      case 241:    //ContinuousTrianglesInvert - Resynchronize
      ...
      case 242:    //ContinuousTriangles - Drift
      ...
      case 243:    //ContinuousTrianglesInvert - Drift
      ...
      case 261:    //Fusee up Red

        fusee_init(0);
        break;
      
      case 262:    //Fusee down Red

        fusee_init(1);
        break;
      
      case 263:    //Fusee left Red

        fusee_init(2);
        break;
      
      case 264:    //Fusee right Red

        fusee_init(3);
        break;
      
      case 265:    //Fusee center Horizontal Red

        fusee_init(4);
        break;
      
      case 266:    //Fusee center Vertical Red

        fusee_init(5);
        break;
      
      case 267:    //WideFlashRed
      ...
      case 296:    //ColorBeatStroboLine

        colorMode(HSB);
        frameRate(25);
        break;
      
      case 297:    //ColorBeatWhiteStroboTriangle

        colorMode(HSB);
        frameRate(25);
        break;
      
      case 298:    //ColorBeatTransition
      ...
      case 304:    //ShiftPixelsUp - Slow

        frameRate(60);
        shiftpixels_speed = shiftpixels_slowspeed;
        break;
      
      case 305:    //ShiftPixelsDown - Slow

        frameRate(60);
        shiftpixels_speed = shiftpixels_slowspeed;
        break;
      
      case 306:    //ShiftPixelsLeft - Slow

        frameRate(60);
        shiftpixels_speed = shiftpixels_slowspeed;
        break;
      
      case 307:    //ShiftPixelsRight - Slow

        frameRate(60);
        shiftpixels_speed = shiftpixels_slowspeed;
        break;
      
      case 308:    //ShiftPixelsUp - Fast

        frameRate(60);
        shiftpixels_speed = shiftpixels_fastspeed;
        break;
      
      case 309:    //ShiftPixelsDown - Fast

        frameRate(60);
        shiftpixels_speed = shiftpixels_fastspeed;
        break;
      
      case 310:    //ShiftPixelsLeft - Fast

        frameRate(60);
        shiftpixels_speed = shiftpixels_slowspeed;
        break;
      
      case 311:    //ShiftPixelsRight - Fast

        frameRate(60);
        shiftpixels_speed = shiftpixels_slowspeed;
        break;
      
      case 312:    //ShredPixelsVertical - Slow

        frameRate(60);
        shiftpixels_speed = shiftpixels_slowspeed;
        break;
      
      case 313:    //ShredPixelsHorizontal - Slow

        frameRate(60);
        shiftpixels_speed = shiftpixels_slowspeed;
        break;
      
      case 314:    //ShredPixelsVertical - Fast

        frameRate(60);
        shiftpixels_speed = shiftpixels_fastspeed;
        break;
      
      case 315:    //ShredPixelsHorizontal - Fast

        frameRate(60);
        shiftpixels_speed = shiftpixels_fastspeed;
        break;
      
      case 316:    //LightFusion
      ...
      case 323:    //RotatingCut - B&W

        frameRate(50);
        colorMode(HSB);
        break;
      
      case 324:    //RotatingCut - Blue

        frameRate(50);
        colorMode(HSB);
        break;
      
      case 325:    //ArcRot - Green
      ...
      case 336:         //NonotakPanelFill - Left
      ...
      case 337:         //NonotakPanelFill - Center
      ...
      case 338:        //NonotakPanelFill - Right
      ...
      case 361:    //ParallelWorlds - Regular
      ...
      case 364:    //ParallelWorlds - Reverse
      ...
      case 366:    //MultiCrecy - Low intensity
      ...
      case 367:    //MultiCrecy - Medium intensity
      ...
      case 368:    //MultiCrecy - High intensity
      ...
      case 369:    //MultiCrecy - Hardcore intensity
      ...
      case 376:    //PeriodicNoise

        frameRate(50);
        break;    
      
      case 377:    //SweepingBallsAndArrows
      ...
      case 379:    //FuckedUpSine3 - no reinit
      ...
      case 380:    //MultiCrecy - Very light intensity
      ...
      case 381:    //MultiCrecy - Double intensity
      ...
      case 386:    //DynamicAngleLines - White
      
        setup_dynamicAngleLines();
        break;
      
      case 387:    //DynamicAngleLines - Half Red
        
        setup_dynamicAngleLines();
        break;
      
      case 388:    //DynamicAngleLines - Red
        
        setup_dynamicAngleLines();
        break;
      
      case 389:    //FauveRandomFlash
      
        frameRate(40);    
        break;
      
      case 390:    //BarWavesWhite
      ...
      case 396:    // Dirty Audio processing - to be modified
      ...
      case 399:    //HypnoAudio - Without audio
